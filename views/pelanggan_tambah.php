                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="alamat" class="form-control" id="inputEmail3" placeholder="Inputkan Alamat Rumah" required>
                            </div>
                        </div>
                        <div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="tgl_masuk" class="form-control" id="inputPassword3" placeholder="Inputkan Tanggal Masuk" required>
                            </div>
                        </div>
						<div class="form-group">
